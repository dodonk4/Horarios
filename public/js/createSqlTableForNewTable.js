const quantityOfTables = () => {
 ...
 let mainDivsContainerLength;
    ...
    addButton.addEventListener('click', () => {
        ...
        let schedules = [
            {celda_value: '8:00 - 9:00', celda_scndId: -1, celda_type: 'schedule'},
            {celda_value: '9:00 - 10:00', celda_scndId: -2, celda_type: 'schedule'},
        ...
        createSqlTableForNewTable(sqlTableName, schedules, cells, userTableName);
